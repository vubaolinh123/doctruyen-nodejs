 ...
 * @desc Lấy danh sách chapter theo truyện
 * @access Private (Admin)
 */
router.get('/story/:storyId', async (req, res) => {
  try {
    const { storyId } = req.params;
    console.log(`[Admin API] Lấy danh sách chapter theo truyện - storyId: ${storyId}`);
...
router.get('/stories/list', async (req, res) => {
  try {
    console.log('[Admin API] Lấy danh sách truyện cho dropdown');
